...
<div class={`device-container ${landscape ? 'landscape' : ''}`}>
	{#if device === 'iPhone X'}
		<div class={`marvel-device iphone-x ${selectedColor}`} style="transform: scale({mappedScale});">
			<div class="notch">
	...
	{:else if device === 'iPhone 8plus'}
		<div class={`marvel-device iphone8plus ${selectedColor}`}>
			<div class="top-bar"></div>
			<div class="sleep"></div>
			<div class="volume"></div>
			<div class="camera"></div>
	...
	{:else if device === 'Note 8'}
		<div class={`marvel-device note8 ${selectedColor}`}>
			<div class="inner"></div>
			<div class="overflow">
	...
	{:else if device === 'iPad'}
		<div class={`marvel-device ipad ${selectedColor}`}>
			<div class="camera"></div>
			{#if src}
				<div class="screen">
					<!-- svelte-ignore a11y-missing-attribute -->
	...
	{:else if device === 'MacBook Pro'}
		<div class={`marvel-device macbook ${selectedColor}`}>
			<div class="top-bar"></div>
			<div class="camera"></div>
			{#if src}
				<div class="screen">
